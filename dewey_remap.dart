...
void convertNumber() {
  ...
  final rules = {
    ...
    RegExp(r'(.*\b)263([^.].*|$)'): "273.2",
    RegExp(r'(.*\b)263\.(\d+)(\b.*)'): "273.2x",
    RegExp(r'(.*\b)264([^.].*|$)'): "273.6",
    RegExp(r'(.*\b)264\.(\d+)(\b.*)'): "273.6x",
    RegExp(r'(.*\b)265([^.].*|$)'): "274",
    RegExp(r'(.*\b)265\.(\d+)(\b.*)'): "274.x",
    RegExp(r'(.*\b)266([^.].*|$)'): "275",
    RegExp(r'(.*\b)266\.(\d+)(\b.*)'): "275.x",
    RegExp(r'(.*\b)267([^.].*|$)'): "276.2",
    RegExp(r'(.*\b)267\.(\d+)(\b.*)'): "276.2x",
    RegExp(r'(.*\b)268([^.].*|$)'): "276.5",
    RegExp(r'(.*\b)268\.(\d+)(\b.*)'): "276.5x",
    RegExp(r'(.*\b)269([^.].*|$)'): "276.8",
    RegExp(r'(.*\b)269\.(\d+)(\b.*)'): "276.8x",
    RegExp(r'(.*\b)270([^.].*|$)'): "277.2",
    RegExp(r'(.*\b)270\.(\d+)(\b.*)'): "277.2x",
    RegExp(r'(.*\b)271([^.].*|$)'): "277.4",
    RegExp(r'(.*\b)271\.(\d+)(\b.*)'): "277.4x",
    RegExp(r'(.*\b)272([^.].*|$)'): "277.6",
    RegExp(r'(.*\b)272\.(\d+)(\b.*)'): "277.6x",
    RegExp(r'(.*\b)273([^.].*|$)'): "277.8",
    RegExp(r'(.*\b)273\.(\d+)(\b.*)'): "277.8x",
    RegExp(r'(.*\b)274([^.].*|$)'): "278.4",
    RegExp(r'(.*\b)274\.(\d+)(\b.*)'): "278.4x",
    RegExp(r'(.*\b)275([^.].*|$)'): "278.5",
    RegExp(r'(.*\b)275\.(\d+)(\b.*)'): "278.5x",
    RegExp(r'(.*\b)276([^.].*|$)'): "278.6",
    RegExp(r'(.*\b)276\.(\d+)(\b.*)'): "278.6x",
    RegExp(r'(.*\b)277([^.].*|$)'): "278.7",
    RegExp(r'(.*\b)277\.(\d+)(\b.*)'): "278.7x",
    RegExp(r'(.*\b)278([^.].*|$)'): "278.8",
    RegExp(r'(.*\b)278\.(\d+)(\b.*)'): "278.8x",
    RegExp(r'(.*\b)279([^.].*|$)'): "278.9",
    RegExp(r'(.*\b)279\.(\d+)(\b.*)'): "278.9x",
    RegExp(r'(.*\b)280([^.].*|$)'): "279",
    RegExp(r'(.*\b)280\.(\d+)(\b.*)'): "279.0x",
    RegExp(r'(.*\b)281([^.].*|$)'): "279.1",
    RegExp(r'(.*\b)281\.(\d+)(\b.*)'): "279.1x",
    RegExp(r'(.*\b)282([^.].*|$)'): "279.2",
    RegExp(r'(.*\b)282\.(\d+)(\b.*)'): "279.2x",
    RegExp(r'(.*\b)283([^.].*|$)'): "279.3",
    RegExp(r'(.*\b)283\.(\d+)(\b.*)'): "279.3x",
    RegExp(r'(.*\b)284([^.].*|$)'): "279.4",
    RegExp(r'(.*\b)284\.(\d+)(\b.*)'): "279.4x",
    RegExp(r'(.*\b)285([^.].*|$)'): "279.5",
    RegExp(r'(.*\b)285\.(\d+)(\b.*)'): "279.5x",
    RegExp(r'(.*\b)286([^.].*|$)'): "279.6",
    RegExp(r'(.*\b)286\.(\d+)(\b.*)'): "279.6x",
    RegExp(r'(.*\b)287([^.].*|$)'): "279.7",
    RegExp(r'(.*\b)287\.(\d+)(\b.*)'): "279.7x",
    RegExp(r'(.*\b)289([^.].*|$)'): "279.9",
    RegExp(r'(.*\b)289\.(\d+)(\b.*)'): "279.9x",
    RegExp(r'(.*\b)291([^.].*|$)'): "201.3",
    RegExp(r'(.*\b)291.13([^.].*|$)'): "201.3",
    RegExp(r'(.*\b)291\.211([^.].*|$)'): "202.11",
    RegExp(r'(.*\b)291\.4([^.].*|$)'): "204",
    RegExp(r'(.*\b)291\.44([^.].*|$)'): "204.4",
    RegExp(r'(.*\b)292([^.].*|$)'): "232",
    RegExp(r'(.*\b)292\.(\d+)(\b.*)'): "232.x",
    RegExp(r'(.*\b)293([^.].*|$)'): "233",
    RegExp(r'(.*\b)293\.(\d+)(\b.*)'): "233.x",
    RegExp(r'(.*\b)294([^.].*|$)'): "223",
    RegExp(r'(.*\b)294\.3([^.].*|$)'): "227",
    RegExp(r'(.*\b)294\.33([^.].*|$)'): "227.1",
    RegExp(r'(.*\b)294\.33(\d+)(\b.*)'): "227.1x",
    RegExp(r'(.*\b)294\.34204([^.].*|$)'): "227.3",
    RegExp(r'(.*\b)294\.34204(\d+)(\b.*)'): "227.3x",
    RegExp(r'(.*\b)294\.34([^.].*|$)'): "227.5",
    RegExp(r'(.*\b)294\.342([^.].*|$)'): "227.5",
    RegExp(r'(.*\b)294\.3421([^.].*|$)'): "227.51",
    RegExp(r'(.*\b)294\.3422([^.].*|$)'): "227.52",
    RegExp(r'(.*\b)294\.3423([^.].*|$)'): "227.53",
    RegExp(r'(.*\b)294\.343([^.].*|$)'): "227.7",
    RegExp(r'(.*\b)294\.343(\d+)(\b.*)'): "227.7x",
    RegExp(r'(.*\b)294\.344([^.].*|$)'): "227.9",
    RegExp(r'(.*\b)294\.344(\d+)(\b.*)'): "227.9x",
    RegExp(r'(.*\b)294\.35([^.].*|$)'): "228.1",
    RegExp(r'(.*\b)294\.35(\d+)(\b.*)'): "228.1x",
    RegExp(r'(.*\b)294\.36([^.].*|$)'): "228.3",
    RegExp(r'(.*\b)294\.36(\d+)(\b.*)'): "228.3x",
    RegExp(r'(.*\b)294\.37([^.].*|$)'): "228.5",
    RegExp(r'(.*\b)294\.37(\d+)(\b.*)'): "228.5x",
    RegExp(r'(.*\b)294\.38([^.].*|$)'): "228.7",
    RegExp(r'(.*\b)294\.38(\d+)(\b.*)'): "228.7x",
    RegExp(r'(.*\b)294\.39([^.].*|$)'): "228.9",
    RegExp(r'(.*\b)294\.39(\d+)(\b.*)'): "228.9x",
    RegExp(r'(.*\b)294\.4([^.].*|$)'): "226",
    RegExp(r'(.*\b)294\.4(\d+)(\b.*)'): "226.x",
    RegExp(r'(.*\b)294\.5([^.].*|$)'): "223.1",
    RegExp(r'(.*\b)294\.51([^.].*|$)'): "223.2",
    RegExp(r'(.*\b)294\.51(\d+)(\b.*)'): "223.2x",
    RegExp(r'(.*\b)294\.52([^.].*|$)'): "223.5",
    RegExp(r'(.*\b)294\.52(\d+)(\b.*)'): "223.5x",
    RegExp(r'(.*\b)294\.53([^.].*|$)'): "223.8",
    RegExp(r'(.*\b)294\.53(\d+)(\b.*)'): "223.8x",
    RegExp(r'(.*\b)294\.54([^.].*|$)'): "224.2",
    RegExp(r'(.*\b)294\.54(\d+)(\b.*)'): "224.2x",
    RegExp(r'(.*\b)294\.55([^.].*|$)'): "224.6",
    RegExp(r'(.*\b)294\.55(\d+)(\b.*)'): "224.6x",
    RegExp(r'(.*\b)294\.56([^.].*|$)'): "225.2",
    RegExp(r'(.*\b)294\.56(\d+)(\b.*)'): "225.2x",
    RegExp(r'(.*\b)294\.57([^.].*|$)'): "225.5",
    RegExp(r'(.*\b)294\.57(\d+)(\b.*)'): "225.5x",
    RegExp(r'(.*\b)294\.59([^.].*|$)'): "225.8",
    RegExp(r'(.*\b)294\.59(\d+)(\b.*)'): "225.8x",
    RegExp(r'(.*\b)294\.6([^.].*|$)'): "229",
    RegExp(r'(.*\b)294\.6(\d+)(\b.*)'): "229.x",
    RegExp(r'(.*\b)295([^.].*|$)'): "235",
    RegExp(r'(.*\b)295([^.].*|$)'): "235.x",
    RegExp(r'(.*\b)296([^.].*|$)'): "251",
    RegExp(r'(.*\b)296\.(\d+)(\b.*)'): "251.x",
    RegExp(r'(.*\b)297([^.].*|$)'): "280",
    RegExp(r'(.*\b)297\.0(\d+)(\b.*)'): "280.0x",
    RegExp(r'(.*\b)297.11([^.].*|$)'): "281",
    RegExp(r'(.*\b)297\.11(\d+)(\b.*)'): "281.x",
    RegExp(r'(.*\b)297\.12([^.].*|$)'): "282",
    RegExp(r'(.*\b)297\.12(\d+)(\b.*)'): "282.x",
    RegExp(r'(.*\b)297\.13([^.].*|$)'): "283",
    RegExp(r'(.*\b)297\.13(\d+)(\b.*)'): "283.x",
    RegExp(r'(.*\b)297\.14([^.].*|$)'): "284",
    RegExp(r'(.*\b)297\.14(\d+)(\b.*)'): "284.x",
    RegExp(r'(.*\b)297\.15([^.].*|$)'): "285",
    RegExp(r'(.*\b)297\.15(\d+)(\b.*)'): "285.x",
    RegExp(r'(.*\b)297\.16([^.].*|$)'): "286",
    RegExp(r'(.*\b)297\.16(\d+)(\b.*)'): "286.x",
    RegExp(r'(.*\b)297\.17([^.].*|$)'): "287",
    RegExp(r'(.*\b)297\.17(\d+)(\b.*)'): "287.x",
    RegExp(r'(.*\b)297\.18([^.].*|$)'): "288",
    RegExp(r'(.*\b)297\.18(\d+)(\b.*)'): "288.x",
    RegExp(r'(.*\b)297\.19([^.].*|$)'): "289",
    RegExp(r'(.*\b)297\.19(\d+)(\b.*)'): "289.x",
    RegExp(r'(.*\b)297\.2([^.].*|$)'): "292",
    RegExp(r'(.*\b)297\.2(\d+)(\b.*)'): "292.x",
    RegExp(r'(.*\b)297\.3([^.].*|$)'): "293",
    RegExp(r'(.*\b)297\.3(\d+)(\b.*)'): "293.x",
    RegExp(r'(.*\b)297\.4([^.].*|$)'): "294",
    RegExp(r'(.*\b)297\.4(\d+)(\b.*)'): "294.x",
    RegExp(r'(.*\b)297\.5([^.].*|$)'): "295",
    RegExp(r'(.*\b)297\.5(\d+)(\b.*)'): "295.x",
    RegExp(r'(.*\b)297\.6([^.].*|$)'): "296",
    RegExp(r'(.*\b)297\.6(\d+)(\b.*)'): "296.x",
    RegExp(r'(.*\b)297\.7([^.].*|$)'): "297",
    RegExp(r'(.*\b)297\.7(\d+)(\b.*)'): "297.x",
    RegExp(r'(.*\b)297\.8([^.].*|$)'): "298",
    RegExp(r'(.*\b)297\.8(\d+)(\b.*)'): "298.x",
    RegExp(r'(.*\b)297\.9([^.].*|$)'): "299.1",
    RegExp(r'(.*\b)297\.9(\d+)(\b.*)'): "299.1x",
    RegExp(r'(.*\b)299\.16([^.].*|$)'): "231",
    RegExp(r'(.*\b)299\.16(\d+)(\b.*)'): "231.x",
    RegExp(r'(.*\b)299\.17([^.].*|$)'): "236.7",
    RegExp(r'(.*\b)299\.17(\d+)(\b.*)'): "236.7x",
    RegExp(r'(.*\b)299\.18([^.].*|$)'): "236.8",
    RegExp(r'(.*\b)299\.18(\d+)(\b.*)'): "236.8x",
    RegExp(r'(.*\b)299\.19([^.].*|$)'): "236.9",
    RegExp(r'(.*\b)299\.19(\d+)(\b.*)'): "236.9x",
    RegExp(r'(.*\b)299\.2([^.].*|$)'): "237",
    RegExp(r'(.*\b)299\.2(\d+)(\b.*)'): "237.x",
    RegExp(r'(.*\b)299\.31([^.].*|$)'): "238",
    RegExp(r'(.*\b)299\.31(\d+)(\b.*)'): "238.x",
    RegExp(r'(.*\b)299\.51([^.].*|$)'): "221",
    RegExp(r'(.*\b)299\.511([^.].*|$)'): "221.1",
    RegExp(r'(.*\b)299\.511(\d+)(\b.*)'): "221.1x",
    RegExp(r'(.*\b)299\.512([^.].*|$)'): "221.6",
    RegExp(r'(.*\b)299\.512(\d+)(\b.*)'): "221.6x",
    RegExp(r'(.*\b)299\.514([^.].*|$)'): "221.2",
    RegExp(r'(.*\b)299\.514(\d+)(\b.*)'): "221.2x",
    RegExp(r'(.*\b)299\.54([^.].*|$)'): "222.2",
    RegExp(r'(.*\b)299\.56([^.].*|$)'): "222.4",
    RegExp(r'(.*\b)299\.561([^.].*|$)'): "222.5",
    RegExp(r'(.*\b)299\.561(\d+)(\b.*)'): "222.5x",
    RegExp(r'(.*\b)299\.57([^.].*|$)'): "222.7",
    RegExp(r'(.*\b)299\.58([^.].*|$)'): "222.8",
    RegExp(r'(.*\b)299\.59([^.].*|$)'): "222.9",
    RegExp(r'(.*\b)299\.6([^.].*|$)'): "239.6",
    RegExp(r'(.*\b)299\.6(\d+)(\b.*)'): "239.6x",
    RegExp(r'(.*\b)299\.7([^.].*|$)'): "239.7",
    RegExp(r'(.*\b)299\.7(\d+)(\b.*)'): "239.7x",
    RegExp(r'(.*\b)299\.8([^.].*|$)'): "239.8",
    RegExp(r'(.*\b)299\.8(\d+)(\b.*)'): "239.8x",
    RegExp(r'(.*\b)299\.9215([^.].*|$)'): "239.915",
    RegExp(r'(.*\b)299\.9215(\d+)(\b.*)'): "239.915x",
    RegExp(r'(.*\b)299\.922([^.].*|$)'): "239.92",
    RegExp(r'(.*\b)299\.922(\d+)(\b.*)'): "239.92x",
    RegExp(r'(.*\b)299\.923([^.].*|$)'): "239.93",
    RegExp(r'(.*\b)299\.923(\d+)(\b.*)'): "239.93x",
    RegExp(r'(.*\b)299\.924([^.].*|$)'): "239.94",
    RegExp(r'(.*\b)299\.924(\d+)(\b.*)'): "239.94x",
    RegExp(r'(.*\b)299\.925([^.].*|$)'): "239.95",
    RegExp(r'(.*\b)299\.925(\d+)(\b.*)'): "239.95x",
    RegExp(r'(.*\b)299\.9292([^.].*|$)'): "239.22",
    RegExp(r'(.*\b)299\.9292(\d+)(\b.*)'): "239.22x",
    RegExp(r'(.*\b)299\.9293([^.].*|$)'): "239.23",
    RegExp(r'(.*\b)299\.9293(\d+)(\b.*)'): "239.23x",
    RegExp(r'(.*\b)299\.9294([^.].*|$)'): "239.24",
    RegExp(r'(.*\b)299\.9294(\d+)(\b.*)'): "239.24x",
    RegExp(r'(.*\b)299\.9295([^.].*|$)'): "239.25",
    RegExp(r'(.*\b)299\.9295(\d+)(\b.*)'): "239.25x",
    RegExp(r'(.*\b)299\.9296([^.].*|$)'): "239.26",
    RegExp(r'(.*\b)299\.9296(\d+)(\b.*)'): "239.26x",
    RegExp(r'(.*\b)299\.93([^.].*|$)'): "299.2",
    RegExp(r'(.*\b)299\.932([^.].*|$)'): "239.4",
    RegExp(r'(.*\b)299\.933([^.].*|$)'): "299.3",
    RegExp(r'(.*\b)299\.934([^.].*|$)'): "299.4",
    RegExp(r'(.*\b)299\.935([^.].*|$)'): "299.5",
    RegExp(r'(.*\b)299\.936([^.].*|$)'): "299.6",
    RegExp(r'(.*\b)299\.94([^.].*|$)'): "299.9",
